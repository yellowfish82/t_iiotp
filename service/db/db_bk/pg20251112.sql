...
-- Started on 2025-11-12 17:03:47 CST
...
SELECT pg_catalog.setval('public.alert_condition_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.thing_instance_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.thing_model_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.thing_model_properties_id_seq', 3, true);
...
-- Completed on 2025-11-12 17:03:47 CST
